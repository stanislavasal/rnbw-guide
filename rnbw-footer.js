        ...
        <footer class="padding-xl box-l">
            <div class="gap-s direction-column align-start box-l">
                ...
                <div class="direction-row gap-s box">
                    <a href="https://rnbw.dev/features">features</a
                    ><a href="https://rnbw.dev/updates" target="_blank"
                        >updates</a
                    ><a href="https://guide.rnbw.dev/">guide</a>
                    <a
                        href="https://discord.com/invite/HycXz8TJkd"
                        target="_blank"
                        >discord ↗</a
                    >
                </div>
                <div class="direction-row gap-s box">
                    <a href="https://rnbw.dev/pricing">pricing</a
                    ><a href="https://rnbw.dev/about">about</a>
                    <a
                ...
                <div class="direction-row gap-s box">
                    ...
                    ><a href="https://rfrncs.design/">rfrncs.design ↗</a>
                </div>
                <div class="direction-row gap-s box">
                    <a
